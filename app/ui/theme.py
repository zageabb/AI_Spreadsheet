...
QLineEdit, QComboBox, QPlainTextEdit, QTextBrowser, QListWidget { background: white; border: 1px solid #dde4ee; border-radius: 7px; padding: 7px; selection-background-color: #1768e5; }
QLineEdit:focus, QComboBox:focus, QPlainTextEdit:focus { border-color: #1768e5; }
QDockWidget { color: #15233a; background: #f3f6fa; }
QDockWidget::title { background: #e8eef8; padding: 8px; font-weight: 600; }
